    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Imgproc.rectangle(rotated_mat_image,new Point(left,top),new Point(right,bottom),new Scalar(0, 255, 255, 0),8);
                Imgproc.putText(rotated_mat_image,labelList.get((int) class_value )+" %"+ formattedNumber,new Point(left,top),3,1,new Scalar(255, 0, 0, 255),3);
            }
